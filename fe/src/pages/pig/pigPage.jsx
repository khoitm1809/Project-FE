...
const PigPage = () => {
    ...
    const title = [
        ...
        { key: "barn.name", label: "barn", isDropDown: true, list: convertToDropdown(listBarn?.data) }, //api list barn 
        { key: "type_pig.name", label: "type_pig", isDropDown: true, list: convertToDropdown(listTypePig?.data) }, //api type pig
        { key: "pig_growth_records.weight", label: "pig_growth_records" }, // ẩn trên dialog
        { key: "users_permissions_user.username", label: "users_permissions_user" }, //người tạo
    ];
    const titleAdd = [
        { key: "pigCode", label: "pigCode" }, //hiện
        { key: "weight", label: "weight" }, //hiện
